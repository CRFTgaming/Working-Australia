...
hint "You have been sold into slavery, time to earn your way out! Start picking cotton! You need 24!";
sleep 15;
slave_task1 = player createSimpleTask ["slave_task_1"];
slave_task1 setSimpleTaskDescription ["Roll 40 Cigarettes, Pick it, roll it and turn them in to gain your freedom.","Rolling your way to freedom",""];
...
[] spawn 
{
	while {life_enslaved && alive player} do 
	{
		...
		{	
			titleText [localize "STR_MISC_Slaveescape1","BLACK OUT"];
			player playMoveNow "Incapacitated";
			sleep 15;
			player setPos (getMarkerPos "slave_trader_center");
			player playMoveNow "AinjPpneMstpSnonWrflDnon_rolltoback";
			sleep 10;
			titleText[localize "STR_MISC_Slaveescape2","PLAIN"];
