...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","heroin_2","heroin_3","cocaine_1","cocaine_2","cocaine_3","weed_1","weed_2","weed_3","rye_1","hops_1","cornmeal_1","yeast_1","slave_trader_center"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["slave_trader_center"]): {_gather = "cotton"; _val = 1;};
	default {""};
};
//gather check??
_addExpAmount = 5;
