...
[[0,format["You have earned %1 XP and a bonus of $%2 for this ticket", _addExpAmount, [_valBon] call life_fnc_numberText]],"life_fnc_broadcast",player,false] spawn life_fnc_MP;
 
life_atmcash = life_atmcash + _value + _valBon; 